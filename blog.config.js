...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AQASLAC', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个孩子的父亲👨@AQASLAC', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-five-theta-93.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 技术分享, 知识分享', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi~，我是David·Yao,Hi~，我是一个程序员,欢迎来到我的博客🎉,这里将知识共享！',
